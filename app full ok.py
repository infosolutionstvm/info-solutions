...
# Terms & Conditions HTML Generator
    ...
    with right_col:
        ...
        if filtered_rows:
            ...
            with tab_update:
                ...
                # --- Action Buttons: Save Edits, WhatsApp & Delete ---
                ...
                with ub1:
                    if st.button("💾 Save Changes", use_container_width=True, type="primary"):
                        ...
                        cursor.execute("""
                            UPDATE services 
                            SET cust_name=?, phone=?, item_type=?, item_desc=?, complaint=?, status=?, service_charge=?, delivery_date=? 
                            WHERE job_no=?
